  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
        <View className="flex-1 justify-center items-center px-5">
            ...
            <Text className="pt-3 text-xl text-center font-semibold text-gray-700">Thanks {userInfo?.fname}</Text>
            <Text className=" text-base text-center font-semibold text-gray-700">Your Order will come in the time u want!</Text>
        </View>
